...
function ForgotPassword() {
    ...
    return (
        <div className="container-xl w-screen h-screen relative bg-navy bg-cover flex flex-col justify-center items-center">
            <div className="w-80 flex flex-col justify-center align-center">
                ...
                {error && <p className="text-white bg-gray-600 bg-opacity-20 p-4">{error}</p>}
                {message && <p className="text-white bg-gray-600 bg-opacity-20 p-4">{message}</p>}
                ...
                <div className="flex justify-between items-center mt-2">
                    ...
                    {message ? 
                        <Link to={ROUTES.LOGIN}>
                            <button className="bg-green-500 rounded p-2 font-bold text-white">
                                Go to login
                            </button>
                        </Link>
                        :
