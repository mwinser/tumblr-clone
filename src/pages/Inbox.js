        ...
        <>
            ...
            <div className="bg-navy h-screen max-w-990px mx-auto px-2 flex flex-col text-white">
                <div className="max-w-990px mx-12 pt-12 px-2 flex justify-center items-start">
                    <div className="max-w-625px w-full lg:w-3/5 mt-5 ml-5 lg:ml-20 mr-5 py-24 px-5 bg-gray-500 bg-opacity-20 text-gray-400 text-center font-bold text-xl rounded">
                    ...
                    <div className="hidden lg:flex max-w-320px w-2/5 flex-col flex-start gap-4">
