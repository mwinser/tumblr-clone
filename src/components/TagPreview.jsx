...
export default function TagPreview() {
    ...
    return (
        <div className="TAGPREVIEW grid grid-cols-2 sm:grid-cols-4 gap-4 mb-5">
            ...
            <div className="bg-yellow-400 bg-green-400 bg-indigo-400 bg-red-400 text-yellow-400 text-green-400 text-indigo-400 text-red-400 hidden"></div>
            {[
                ...
                return (
                    <div key={item.tag + item.color} className={`bg-${item.color||`blue`}-400 flex flex-col p-2 rounded`}>
