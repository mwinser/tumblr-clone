        ...
        <header className="sticky top-0 left-0 z-10 bg-navy flex justify-center border-b-2 border-white border-opacity-10">
            ...
            <div className="relative max-w-screen-2xl w-full flex items-center justify-between h-14 text-white  mx-auto, pl-6 pr-5">
                ...
                <div className="flex justify-end items-center fill-current">
                    <div className="mx-4 opacity-70" title="Dashboard">
                        <Link to={ROUTES.DASHBOARD}>
                    ...
                    <div className="mx-4 opacity-70" title="Recommended">
                    ...
                    <div className="mx-4 opacity-70" title="Inbox">
                    ...
                    <div className="mx-4 opacity-70" title="Messaging (under contstruction)">
                    ...
                    <div className="mx-4 opacity-70" title="Notifications (under construction)">
                    ...
                    <div className="mx-4 opacity-70 cursor-pointer" title="Account" onClick={()=>toggleMenu()}>
                    ...
                    <div  onClick={()=>setIsCreateMenuOpen(true)} className="mx-4 py-1.5 px-3 bg-blue-400 rounded cursor-pointer" title="Create Post">
