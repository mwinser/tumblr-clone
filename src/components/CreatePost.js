...
function CreatePost() {
    ...
    async function handleSubmit (e) {
        ...
        try {
            ...
            let type = "text"
            let webImage = document.getElementById('img-preview').src
        ...
        return (
            ...
            <div className="CONTAINER relative bg-white rounded max-w-lg max-h-112 z-30">
                ...
                <div className="flex flex-col bg-white rounded-b">
                <div className={`flex font-bold text-gray-400 mb-5 bg-gray-200 border-t-2 border-b-2 border-dashed border-gray-400 divide-x divide-gray-400 ${showPreview||showUrlInput ? "hidden" : null}`}>  
                    ...
                    <div
                        className="w-72 h-48 flex flex-col justify-center items-center cursor-pointer"
                    ...
                    <>
                        {showUrlInput &&
                            <form className="w-72 h-48 flex flex-col justify-center items-center" onSubmit={e=>handleUrlSubmit(e)}>
                                <input 
                                    type="url"
                                    id="url"
                                    name="url"
